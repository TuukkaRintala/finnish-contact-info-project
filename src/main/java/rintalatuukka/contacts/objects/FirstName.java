...
/**
 * This object contains a first name and methods to manipulate that data.
 *
...
public class FirstName implements Info {
     ...
     */
    public FirstName(final String startInfo) {
        setInfo(startInfo);
    }
     ...
     * argument.
     *
     * @param newInfo a String containing the first name we wish to validate.
    ...
    public void inputInfo() {
        ...
        while (!validInput) {
            System.out.println("Please give the first name of the contact:");
            validInput = true;
            try {
